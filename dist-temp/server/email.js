...
export async function sendEmail(to, subject, html) {
    ...
    const resolvedFromEmail = SMTP_HOST.includes("gmail.com") && SMTP_USER ? SMTP_USER : FROM_EMAIL || SMTP_USER;
...
export async function sendInvitationEmail(email, name, token, role) {
...
<body>
  ...
  `;
    return sendEmail(email, "دعوة للانضمام إلى VevoLine Dashboard / Invitation to VevoLine Dashboard", html);
}
...
<body>
  ...
  `;
    return sendEmail(email, "إعادة تعيين كلمة المرور / Password Reset - VevoLine Dashboard", html);
}
